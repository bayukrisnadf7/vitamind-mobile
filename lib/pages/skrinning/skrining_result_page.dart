          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // TOMBOL DAFTAR KONSULTASI PSIKOLOG (Mengarahkan ke Tab Psikolog)
                ElevatedButton(
                  onPressed: () {
                    controller.resetSkrining();
                    // Navigasi ke MainNavigation dan kirim indeks 2 (Psikolog) sebagai argumen
                ...
                OutlinedButton(
                  onPressed: () {
                    controller.resetSkrining();
                    // Navigasi ke MainNavigation (default tab 0)
                    Get.offAll(() => const MainNavigation());
                  },
